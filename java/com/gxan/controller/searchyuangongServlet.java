...
@WebServlet("/searchyuangong")
public class searchyuangongServlet extends HttpServlet {
    @Override
    protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        JsonResult jsonResult = yuangongService.searchyuangongList(currentName,currentPage, pageSize);
        //响应
